...
“Solar Water Heater- Anil” by **aniljaco**:
https://skfb.ly/onWWG

Licensed under **Creative Commons Attribution 4.0 International**:
https://creativecommons.org/licenses/by/4.0/

The supplied GLB's attribution is retained in the adapted asset. Adaptations: removed detailed bolt nodes, pruned unused data, deduplicated/welded geometry, normalized display scale and added procedural scene lighting. Model materials remain based on the source. The original supplied file is preserved outside the repository. `public/models/solar-heater.glb` is the optimized derivative. The visible website credits are available in the footer under “Créditos y fuentes”.

## Icons and typefaces

- Google Material Symbols Rounded, font subset; Google Material Icons `wb_sunny` for the favicon. Apache License 2.0. https://github.com/google/material-design-icons
...
- CONUEE, installation and maintenance: https://www.gob.mx/conuee/acciones-y-programas/calentamiento-solar-de-agua-instalacion-y-mantenimiento?state=published
